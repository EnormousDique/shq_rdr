...
public class L1B1P1F1_5 extends Level
{

    private static L1B1P1F1_5 instance;
    public static L1B1P1F1_5 getInstance() throws IOException {
        if(instance == null) return new L1B1P1F1_5(); else return instance;
    }
    private L1B1P1F1_5() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
