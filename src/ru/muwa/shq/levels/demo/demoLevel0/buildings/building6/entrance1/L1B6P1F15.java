...
public class L1B6P1F15 extends Level
{

    private static L1B6P1F15 instance;
    public static L1B6P1F15 getInstance() throws IOException {
        if(instance == null) return new L1B6P1F15(); else return instance;
    }
    private L1B6P1F15() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
