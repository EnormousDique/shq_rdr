...
public class L1B7P2F13_Stairs extends Level {
    private static L1B7P2F13_Stairs instance;
    public static L1B7P2F13_Stairs getInstance() throws IOException {
        if(instance == null) return new L1B7P2F13_Stairs(); else return instance;
    }
    private L1B7P2F13_Stairs() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());

        zones.add(new EnterZone(5,41,60,60, L1B7P2F12_5_Stairs.getInstance(), 361,35,false));
        zones.add(new EnterZone(3,154,46,60, L1B7P2F13_5_Stairs.getInstance(),355 ,165,false));
        zones.add(new EnterZone(360,221,46,40, L1B7P2F13.getInstance(),746 ,68,false));
