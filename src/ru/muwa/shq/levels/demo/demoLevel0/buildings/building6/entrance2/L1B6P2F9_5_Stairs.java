...
import ru.muwa.shq.levels.demo.demoLevel0.buildings.building6.entrance1.L1B6P1F9_Stairs;
...
public class L1B6P2F9_5_Stairs extends Level
{

    private static L1B6P2F9_5_Stairs instance;
    public static L1B6P2F9_5_Stairs getInstance() throws IOException {
        if(instance == null) return new L1B6P2F9_5_Stairs(); else return instance;
    }
    private L1B6P2F9_5_Stairs() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
        ...
        zones.add(new EnterZone(350,159,60,60, L1B6P1F9_Stairs.getInstance(), 6,153,false));
        zones.add(new EnterZone(350,35,46,50, L1B6P1F10_Stairs.getInstance(),5 ,40,false));
