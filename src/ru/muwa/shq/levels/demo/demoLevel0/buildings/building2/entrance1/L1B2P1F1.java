package ru.muwa.shq.levels.demo.demoLevel0.buildings.building2.entrance1;
...
public class L1B2P1F1 extends Level
{
    private static L1B2P1F1 instance;
    public static L1B2P1F1 getInstance() throws IOException {
        if(instance == null) return new L1B2P1F1(); else return instance;
    }
    private L1B2P1F1() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;

        zones.add(new EnterZone(300,164,60,80, DemoLevel0.getInstance(), 1900,1920,false));
