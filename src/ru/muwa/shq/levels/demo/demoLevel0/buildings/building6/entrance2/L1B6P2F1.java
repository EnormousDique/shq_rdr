...
public class L1B6P2F1 extends Level
{

    private static L1B6P2F1 instance;
    public static L1B6P2F1 getInstance() throws IOException {
        if(instance == null) return new L1B6P2F1(); else return instance;
    }
    private L1B6P2F1() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        ...
        objects.add(new BG());
        zones.add(new EnterZone(505,739,60,80, DemoLevel0.getInstance(), 2214,2940,false));
