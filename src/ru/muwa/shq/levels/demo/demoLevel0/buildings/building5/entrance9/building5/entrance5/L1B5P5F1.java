package ru.muwa.shq.levels.demo.demoLevel0.buildings.building5.entrance9.building5.entrance5;
...
public class L1B5P5F1 extends Level
{
    ...
    private L1B5P5F1() throws IOException {
        ...
        zones.add(new EnterZone(730,730,70,70, DemoLevel0.getInstance(),6715 ,900,true));
    }
}
