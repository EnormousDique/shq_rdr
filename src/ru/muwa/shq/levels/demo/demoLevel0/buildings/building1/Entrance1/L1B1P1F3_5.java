...
public class L1B1P1F3_5 extends Level {

    private static L1B1P1F3_5 instance;

    public static L1B1P1F3_5 getInstance() throws IOException {
        if (instance == null) return new L1B1P1F3_5();
    ...
    private L1B1P1F3_5() throws IOException {
        ...
        zones.add(new EnterZone(15,35,60,80, L1B1P1F3.getInstance(), 100, 50, true));
        zones.add(new EnterZone(13,162,60,80, L1B1P1F4.getInstance(), 100, 250, true));
