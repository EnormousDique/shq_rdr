package ru.muwa.shq.levels.demo.demoLevel0.buildings.building5.entrance9.building5.entrance9;
...
public class L1B5P9F1 extends Level
{
    ...
    private L1B5P9F1() throws IOException {
        ...
        zones.add(new EnterZone(730,730,70,70, DemoLevel0.getInstance(),7823 ,900,true));
    }
}
