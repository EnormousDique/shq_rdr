...
public class L1B10P1F10 extends Level
{

    private static L1B10P1F10 instance;
    public static L1B10P1F10 getInstance() throws IOException {
        if(instance == null) return new L1B10P1F10(); else return instance;
    }
    private L1B10P1F10() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
        ...
        zones.add(new EnterZone(1439,812,40,70,L1B10P1F10_Stairs.getInstance(),50,333,false));
