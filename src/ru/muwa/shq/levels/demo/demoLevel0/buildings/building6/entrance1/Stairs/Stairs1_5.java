...
public class Stairs1_5 extends Level
{

    private static Stairs1_5 instance;
    public static Stairs1_5 getInstance() throws IOException {
        if(instance == null) return new Stairs1_5(); else return instance;
    }
    private Stairs1_5() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
        ...
        zones.add(new EnterZone(382,33,60,80, Stairs2.getInstance(), 4,41,false));
