package ru.muwa.shq.levels.demo.demoLevel0.buildings.building6.entrance1.entrance2;
...
public class L1B6P2F1 extends Level
{
    ...
    private L1B6P2F1() throws IOException {
        ...
        zones.add(new EnterZone(505,739,60,80, DemoLevel0.getInstance(), 2215,2940,false));
