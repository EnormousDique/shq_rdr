...
public class L1B6P1F6 extends Level
{

    private static L1B6P1F6 instance;
    public static L1B6P1F6 getInstance() throws IOException {
        if(instance == null) return new L1B6P1F6(); else return instance;
    }
    private L1B6P1F6() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
