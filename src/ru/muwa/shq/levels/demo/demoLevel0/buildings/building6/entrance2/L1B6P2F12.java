...
public class L1B6P2F12 extends Level
{

    private static L1B6P2F12 instance;
    public static L1B6P2F12 getInstance() throws IOException {
        if(instance == null) return new L1B6P2F12(); else return instance;
    }
    private L1B6P2F12() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
