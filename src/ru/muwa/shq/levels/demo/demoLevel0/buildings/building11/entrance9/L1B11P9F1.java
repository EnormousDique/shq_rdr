...
package ru.muwa.shq.levels.demo.demoLevel0.buildings.building11.entrance9;
...
public class L1B11P9F1 extends Level
{

    private static L1B11P9F1 instance;
    public static L1B11P9F1 getInstance() throws IOException {
        if(instance == null) return new L1B11P9F1(); else return instance;
    }
    private L1B11P9F1() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        // containers.add(new PostBox(100,100));
        objects.add(new GreyPadick(0,0));
        zones.add(new EnterZone(505,739,60,80, DemoLevel0.getInstance(), 7900  ,8000,false));
