package ru.muwa.shq.levels.demo.demoLevel0.buildings.building8.entrance3;
...
public class L1B8P3F1 extends Level
{
    private static L1B8P3F1 instance;
    public static L1B8P3F1 getInstance() throws IOException {
        if(instance == null) return new L1B8P3F1(); else return instance;
    }
    private L1B8P3F1() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
