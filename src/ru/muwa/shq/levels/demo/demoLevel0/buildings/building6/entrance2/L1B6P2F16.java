...
public class L1B6P2F16 extends Level
{

    private static L1B6P2F16 instance;
    public static L1B6P2F16 getInstance() throws IOException {
        if(instance == null) return new L1B6P2F16(); else return instance;
    }
    private L1B6P2F16() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
