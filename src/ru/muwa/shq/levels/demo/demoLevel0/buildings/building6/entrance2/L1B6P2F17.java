...
public class L1B6P2F17 extends Level
{

    private static L1B6P2F17 instance;
    public static L1B6P2F17 getInstance() throws IOException {
        if(instance == null) return new L1B6P2F17(); else return instance;
    }
    private L1B6P2F17() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
