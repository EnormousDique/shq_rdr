package ru.muwa.shq.levels.demo.demoLevel0.buildings.building9.entrance4;
...
public class L1B9P4F1 extends Level
{
    private static L1B9P4F1 instance;
    public static L1B9P4F1 getInstance() throws IOException {
        if(instance == null) return new L1B9P4F1(); else return instance;
    }
    private L1B9P4F1() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
