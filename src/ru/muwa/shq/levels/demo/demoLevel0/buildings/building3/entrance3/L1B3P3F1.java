package ru.muwa.shq.levels.demo.demoLevel0.buildings.building3.entrance3;
...
public class L1B3P3F1 extends Level
{
    private static L1B3P3F1 instance;
    public static L1B3P3F1 getInstance() throws IOException {
        if(instance == null) return new L1B3P3F1(); else return instance;
    }
    private L1B3P3F1() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;

        zones.add(new EnterZone(300,164,60,80, DemoLevel0.getInstance(), 4560,800,false));
