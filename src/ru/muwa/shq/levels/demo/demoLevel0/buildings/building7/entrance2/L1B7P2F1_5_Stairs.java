...
public class L1B7P2F1_5_Stairs extends Level {
    private static L1B7P2F1_5_Stairs instance;
    public static L1B7P2F1_5_Stairs getInstance() throws IOException {
        if(instance == null) return new L1B7P2F1_5_Stairs(); else return instance;
    }
    private L1B7P2F1_5_Stairs() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());

        zones.add(new EnterZone(382,33,60,80, L1B7P2F2_Stairs.getInstance(), 4,41,false));
        zones.add(new EnterZone(48,220,46,50, L1B7P2F1.getInstance(),80 ,185,false));
