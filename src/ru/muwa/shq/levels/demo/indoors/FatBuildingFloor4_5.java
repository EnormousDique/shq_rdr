...
public class FatBuildingFloor4_5 extends Level {

    private static FatBuildingFloor4_5 instance;

    public static FatBuildingFloor4_5 getInstance() throws IOException {
        if (instance == null) return new FatBuildingFloor4_5();
        else return instance;
    }

    private FatBuildingFloor4_5() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
        // containers.add(new PostBox(100,100));
        zones.add(new EnterZone(15,35,60,80, FatBuildingFloor4.getInstance(), 100, 50, true));
        zones.add(new EnterZone(13,162,60,80, FatBuildingFloor5.getInstance(), 100, 250, true));
