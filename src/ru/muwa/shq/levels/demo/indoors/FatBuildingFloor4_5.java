...
public class FatBuildingFloor4_5 extends Level {
    ...
    private FatBuildingFloor4_5() throws IOException {
        ...
        zones.add(new EnterZone(10, 65, 70, 70, FatBuildingFloor4.getInstance(), 100, 50, true));
        zones.add(new EnterZone(10, 195, 70, 70, FatBuildingFloor5.getInstance(), 100, 250, true));
