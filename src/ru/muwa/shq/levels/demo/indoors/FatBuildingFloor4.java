...
public class FatBuildingFloor4 extends Level
{
    ...
    private FatBuildingFloor4() throws IOException {
        ...
        zones.add(new EnterZone(300,150,100,100, FatBuildingFloor3_5.getInstance(), 250,205,true));
          zones.add(new EnterZone(240,30,50,50, FatBuildingFloor4_5.getInstance(), 300,100,true));
