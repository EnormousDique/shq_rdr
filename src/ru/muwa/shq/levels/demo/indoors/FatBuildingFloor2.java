...
public class FatBuildingFloor2 extends Level
{
    ...
    private FatBuildingFloor2() throws IOException {
        ...
        zones.add(new EnterZone(300,164,60,80, FatBuildingFloor1_5.getInstance(), 250,205,true));
        zones.add(new EnterZone(310,30,60,80, FatBuildingFloor2_5.getInstance(), 300,100,true));
