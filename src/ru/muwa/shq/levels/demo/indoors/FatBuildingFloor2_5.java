...
public class FatBuildingFloor2_5 extends Level {

    private static FatBuildingFloor2_5 instance;

    public static FatBuildingFloor2_5 getInstance() throws IOException {
        if (instance == null) return new FatBuildingFloor2_5();
        else return instance;
    }

    private FatBuildingFloor2_5() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
        // containers.add(new PostBox(100,100));
        zones.add(new EnterZone(10, 65, 70, 70, FatBuildingFloor2.getInstance(), 100, 50, true));
        zones.add(new EnterZone(10, 195, 70, 70, FatBuildingFloor3.getInstance(), 100, 250, true));
