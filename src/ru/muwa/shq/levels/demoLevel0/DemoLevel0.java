package ru.muwa.shq.levels.demoLevel0;
...
import ru.muwa.shq.levels.demoLevel0.buildings.building1.Entrance1.L1B1P1F3_5;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.police.PoliceHQ;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.post.PostOffice;
import ru.muwa.shq.levels.demoLevel0.buildings.drugstore.DrugStoreInteriors;
import ru.muwa.shq.levels.demoLevel0.buildings.grocery.GroceryInteriors;
...
import ru.muwa.shq.levels.demoLevel0.buildings.building1.Entrance1.L1B1P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building1.Entrance2.L1B1P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building1.Entrance3.L1B1P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building1.Entrance4.L1B1P4F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building10.entrance1.L1B10P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building10.entrance2.L1B10P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance1.L1B11P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance2.L1B11P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance2.L1B11P7F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance3.L1B11P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance4.L1B11P4F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance5.L1B11P5F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance6.L1B11P6F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance8.L1B11P8F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building11.entrance9.L1B11P9F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building12.entrance1.L1B12P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building13.entrance1.L1B13P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building2.entrance1.L1B2P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building2.entrance2.L1B2P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building2.entrance3.L1B2P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building2.entrance4.L1B2P4F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building3.entrance1.L1B3P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building3.entrance2.L1B3P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building3.entrance3.L1B3P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building3.entrance4.L1B3P4F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building4.entrance1.L1B4P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building4.entrance2.L1B4P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building4.entrance3.L1B4P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building4.entrance4.L1B4P4F1;
//import ru.muwa.shq.levels.demoLevel0.buildings.building5.Entrance1.L1B5P10F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.Entrance1.L1B5P1F1;

import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance10.L1B5P10F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance11.L1B5P11F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance2.L1B5P22F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance3.L1B5P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance4.L1B5P4F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance5.L1B5P5F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance6.L1B5P6F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance7.L1B5P7F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance8.L1B5P8F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building5.entrance9.L1B5P9F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building6.entrance1.L1B6P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building6.entrance2.L1B6P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building7.entrance1.L1B7P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building7.entrance2.L1B7P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building8.entrance1.L1B8P1F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building8.entrance2.L1B8P2F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building8.entrance3.L1B8P3F1;
import ru.muwa.shq.levels.demoLevel0.buildings.building8.entrance4.L1B8P4F1;
import ru.muwa.shq.levels.demoLevel0.buildings.market.MarketInteriors;
import ru.muwa.shq.levels.demoLevel0.buildings.market.VegetablesVendor;
...
public class DemoLevel0 extends Level
{
    ...
    private DemoLevel0() throws IOException
    {
        ...
        //Вход в подъезд : 1
        zones.add(new MiniGameZone(1900,725,70,70,new Domofon("228k1488", /*L1B1P1F1.getInstance() */ Building_1.getInstance(), 230,2010)));
        ...
        //Вход в подъезд : 2
        zones.add(new MiniGameZone(2255,725,70,70,new Domofon("228k1488",/*L1B1P1F1.getInstance() */ Building_1.getInstance(), 230 + 1600,2010)));
        //Вход в подъезд : 3
        zones.add(new MiniGameZone(2615,725,70,70,new Domofon("228k1488",/*L1B1P1F1.getInstance() */ Building_1.getInstance(), 230 + 1600*2,2010)));
        //Вход в подъезд : 4
        zones.add(new MiniGameZone(2970,725,70,70,new Domofon("228k1488",/*L1B1P1F1.getInstance() */ Building_1.getInstance(), 230 + 1600*3,2010)));
