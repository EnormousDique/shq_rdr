...
public class L1B6P1F5 extends Level
{

    private static L1B6P1F5 instance;
    public static L1B6P1F5 getInstance() throws IOException {
        if(instance == null) return new L1B6P1F5(); else return instance;
    }
    private L1B6P1F5() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
