...
public class L1B6P1F10 extends Level
{

    private static L1B6P1F10 instance;
    public static L1B6P1F10 getInstance() throws IOException {
        if(instance == null) return new L1B6P1F10(); else return instance;
    }
    private L1B6P1F10() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
