...
public class L1B6P1F11 extends Level
{

    private static L1B6P1F11 instance;
    public static L1B6P1F11 getInstance() throws IOException {
        if(instance == null) return new L1B6P1F11(); else return instance;
    }
    private L1B6P1F11() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
