...
public class L1B6P1F3_5_Stairs extends Level
{

    private static L1B6P1F3_5_Stairs instance;
    public static L1B6P1F3_5_Stairs getInstance() throws IOException {
        if(instance == null) return new L1B6P1F3_5_Stairs(); else return instance;
    }
    private L1B6P1F3_5_Stairs() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
