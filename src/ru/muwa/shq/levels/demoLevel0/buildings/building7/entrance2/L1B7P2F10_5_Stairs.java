...
public class L1B7P2F10_5_Stairs extends Level {
    private static L1B7P2F10_5_Stairs instance;
    public static L1B7P2F10_5_Stairs getInstance() throws IOException {
        if(instance == null) return new L1B7P2F10_5_Stairs(); else return instance;
    }
    private L1B7P2F10_5_Stairs() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
        ...
        zones.add(new EnterZone(350,159,60,60, L1B7P2F10_Stairs.getInstance(), 6,153,false));
        zones.add(new EnterZone(350,35,60,60, L1B7P2F11_Stairs.getInstance(), 4,41,false));
