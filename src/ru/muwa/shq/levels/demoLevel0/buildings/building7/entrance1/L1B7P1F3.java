...
public class L1B7P1F3 extends Level {
    private static L1B7P1F3 instance;
    public static L1B7P1F3 getInstance() throws IOException {
        if(instance == null) return new L1B7P1F3(); else return instance;
    }
    private L1B7P1F3() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
