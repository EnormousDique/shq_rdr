...
public class L1B7P2F4 extends Level {
    private static L1B7P2F4 instance;
    public static L1B7P2F4 getInstance() throws IOException {
        if(instance == null) return new L1B7P2F4(); else return instance;
    }
    private L1B7P2F4() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;

        objects.add(new BG());
        zones.add(new EnterZone(771 ,8,50,70, L1B7P2F4_Stairs.getInstance(),348,182,false));
