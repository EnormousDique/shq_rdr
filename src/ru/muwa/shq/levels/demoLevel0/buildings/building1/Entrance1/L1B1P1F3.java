...
public class L1B1P1F3 extends Level
{

    private static L1B1P1F3 instance;
    public static L1B1P1F3 getInstance() throws IOException {
        if(instance == null) return new L1B1P1F3(); else return instance;
    }
    private L1B1P1F3() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
        // containers.add(new PostBox(100,100));
        zones.add(new EnterZone(300,164,60,80,  L1B1P1F2_5.getInstance(), 250,205,true));
        zones.add(new EnterZone(309,13,60,80,  L1B1P1F3_5.getInstance(), 300,100,true));
