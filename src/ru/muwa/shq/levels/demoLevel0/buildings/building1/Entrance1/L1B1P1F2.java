...
public class L1B1P1F2 extends Level
{

    private static L1B1P1F2 instance;
    public static L1B1P1F2 getInstance() throws IOException {
        if(instance == null) return new L1B1P1F2(); else return instance;
    }
    private L1B1P1F2() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
        // containers.add(new PostBox(100,100));
        zones.add(new EnterZone(300,164,60,80, L1B1P1F1_5.getInstance(), 250,205,true));
        zones.add(new EnterZone(310,30,60,80, L1B1P1F2_5.getInstance(), 300,100,true));
