...
public class L1B1P1F4_5 extends Level {

    private static L1B1P1F4_5 instance;

    public static L1B1P1F4_5 getInstance() throws IOException {
        if (instance == null) return new L1B1P1F4_5();
        else return instance;
    }

    private L1B1P1F4_5() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
        // containers.add(new PostBox(100,100));
        zones.add(new EnterZone(15,35,60,80,  L1B1P1F4.getInstance(), 100, 50, true));
        zones.add(new EnterZone(13,162,60,80,  L1B1P1F5.getInstance(), 100, 250, true));
