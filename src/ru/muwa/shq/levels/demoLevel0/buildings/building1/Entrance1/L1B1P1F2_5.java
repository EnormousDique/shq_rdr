...
public class L1B1P1F2_5 extends Level {

    private static L1B1P1F2_5 instance;

    public static L1B1P1F2_5 getInstance() throws IOException {
        if (instance == null) return new L1B1P1F2_5();
        else return instance;
    }

    private L1B1P1F2_5() throws IOException {
        instance = this;
        startPosX = 0;
        startPosY = 0;
        // containers.add(new PostBox(100,100));
        zones.add(new EnterZone(15,35,60,80,  L1B1P1F2.getInstance(), 100, 50, true));
        zones.add(new EnterZone(13,162,60,80,  L1B1P1F3.getInstance(), 100, 250, true));
