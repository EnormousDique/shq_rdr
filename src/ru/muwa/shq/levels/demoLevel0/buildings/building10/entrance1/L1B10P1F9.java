...
public class L1B10P1F9 extends Level
{

    private static L1B10P1F9 instance;
    public static L1B10P1F9 getInstance() throws IOException {
        if(instance == null) return new L1B10P1F9(); else return instance;
    }
    private L1B10P1F9() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
        ...
        zones.add(new EnterZone(1439,812,40,70,L1B10P1F9_Stairs.getInstance(),50,333,false));
