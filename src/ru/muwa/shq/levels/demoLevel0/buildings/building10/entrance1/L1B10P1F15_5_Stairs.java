...
public class L1B10P1F15_5_Stairs extends Level
{

    private static L1B10P1F15_5_Stairs instance;
    public static L1B10P1F15_5_Stairs getInstance() throws IOException {
        if(instance == null) return new L1B10P1F15_5_Stairs(); else return instance;
    }
    private L1B10P1F15_5_Stairs() throws IOException {
        instance = this;
        startPosX = 357;
        startPosY = 418;
        objects.add(new BG());
        ...
        zones.add(new EnterZone(0,296,40,150,L1B10P1F15_Stairs.getInstance(),505,340,false));
